    ...
    >
      <View style={styles.scrollView}>
        <View style={styles.logoContainer}>
          ...
          <TouchableOpacity style={{ position: "absolute", right: 25 }} onPress={async () => setShowModalLogout(true)}>
          ...
          <Ionicons
            ...
            />
            <ModalLogOutScreen showModal={showModalLogout} onChangeModal={onChangeModal} />
            </TouchableOpacity>
        </View>
      ...
      >
        <View style={styles.modalBackground}>
          <View style={styles.modalContainer}>
            <Text style={styles.textHeader}>{timeCount>0?'Unfortunately!':'Caution!'}</Text>
            <Text style={styles.textSub}>{timeCount>0?`You didn't reach your goal today \nTotal focused time: ${formattedTime} min`:`You didn't entered the time \nPlaease enter the time before starting`}</Text>
            <TouchableOpacity
              style={[styles.closeButton]}
              onPress={() => {
                setShowModal(!showModal)
                if (timeCount>0) navigation.navigate('Home',{timeData:timeCount})
              }}
            >
      ...
      >
        <View style={styles.modalBackground}>
          <View style={styles.modalContainer}>
            ...
            <Text style={styles.textSub}>{`You did well today, keep it up \nTotal focused time: ${time} min`}</Text>
            <TouchableOpacity
              style={[styles.closeButton]}
              onPress={() => {
